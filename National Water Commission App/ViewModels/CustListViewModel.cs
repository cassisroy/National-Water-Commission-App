...
{
    public partial class CustListViewModel : BaseViewModel
    {
        const string editButtonText1 = "Update";
        const string createButtonText1 = "Add";
        public ObservableCollection<Customers1> Customer1 { get; private set; } = new();
        public CustListViewModel() 
        {
            Title = "National Water Commission";
            AddEditButtonText1 = createButtonText1;
            GetCustList().Wait();
        }
        ...
        async Task GetCustList()
        {
            ...
            try
            {
                ...
                var customer1 = App.CustService.GetCustomers1();
        ...
        [RelayCommand]
        async Task GetCustDetails1(int id)
        {
            if (id == 0) return;
        ...
        [RelayCommand]
        async Task SetEditModel(int id)
        {
            AddEditButtonText1 = editButtonText1;
            CustomerId = id;
